                   ...
                   <span class="right-bar"></span></span></a>
                    ...
                    <span class="right-bar"></span></span></a>
                        ...
                        @if(Session::get('customerId'))
                            <li class="nav-item"><a href="{{ route('customer.logout') }}" class="btn btn-solid btn-read text-light">Logout</a></li>
                            <li class="nav-item"><a href="" class="btn btn-solid btn-read text-light">{{ Session::get('customerName') }}</a></li>
                        @else
    ...
    <div class="sticky-sidebar">
        <div class="sticky-sidebar-content">
            ...
            <div class="author-img">
                <img src="{{asset('frontEndAsset')}}/assets/images/author.jpg" alt="">
            </div>
            ...
            <div class="author-posts">
                ...
                <div class="card mb-4">
                    <div class="row no-gutters">
                        <div class="col-4 col-md-4">
                            <a href="single-layout-one.html">
                                <img src="{{asset('frontEndAsset')}}/assets/images/alone.jpg" class="card-img" alt="">
                            </a>
                        </div>
                        <div class="col-8 col-md-8">
                            <div class="card-body">
                ...
                <div class="card mb-4">
                    <div class="row no-gutters">
                        <div class="col-4 col-md-4">
                            <a href="single-layout-one.html">
                                <img src="{{asset('frontEndAsset')}}/assets/images/forest.jpg" class="card-img" alt="">
                            </a>
                        </div>
                        <div class="col-8 col-md-8">
                            <div class="card-body">
