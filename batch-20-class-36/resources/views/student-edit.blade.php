                        ...
                        <div class="card-body">
                            <form action="{{ route('update.student') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row my-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="seid" value="{{ $student->seid }}" class="form-control" placeholder="Seip Id">
                                    </div>
                                </div>
                                <div class="form-group row my-3">
                                ...
                                <div class="form-group row my-3">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="address" class="form-control" placeholder="Address" id="" cols="50" rows="5">{{ $student->address }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row my-3">
                                    <label for="" class="col-form-label col-md-3">Department</label>
                                    <div class="col-md-9">
                                        <input type="text" name="department" value="{{ $student->department }}" class="form-control" placeholder="Department">
                                    </div>
                                </div>
                                <div class="form-group row my-3">
                                    <label for="" class="col-form-label col-md-3">Course Name</label>
                                    <div class="col-md-9">
                                        <input type="text" name="course_name" value="{{ $student->course_name }}" class="form-control" placeholder="Course Name">
                                    </div>
                                </div>
                                <div class="form-group row my-3">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="file" name="image" value="{{ $student->image }}" class="form-control" placeholder="Course Name">
