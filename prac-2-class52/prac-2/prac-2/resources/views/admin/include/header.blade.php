        ...
        <div class="nav">
            ...
            <div class="collapse" id="product" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="{{ route('admin.product.add-product') }}">Add Product</a>
                    <a class="nav-link" href="{{ route('admin.product.manage-product') }}">Manage Product</a>
                </nav>
            </div>
...
{{--            user start--}}
            ...
            <div class="collapse" id="user" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="{{ route('admin.user.add-user') }}">Add User</a>
                    <a class="nav-link" href="{{ route('admin.user.manage-user') }}">Manage User</a>
                </nav>
            </div>
{{--            //user end--}}
