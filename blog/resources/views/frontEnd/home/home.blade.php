            ...
            <div class="row">
                <div class="col-md-7 col-lg-8">
                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title title-font"><a href="{{ route('blog.details',['slug'=>$blog->slug]) }}">Making time for travel</a>
                                    </h5>
                    ...
                    <div class="card mb-4">
                        <div class="row no-gutters align-items-center">
                            <div class="col-md-4">
                                <a href="single-layout-one.html"> <img src="{{asset('frontEndAsset')}}/assets/images/alone-house.jpg" class="card-img"
                                                                       alt=""></a>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
