...
<script src="{{ asset('admin-asset') }}/assets/demo/chart-area-demo.js"></script>
<script src="{{ asset('admin-asset') }}/assets/demo/chart-bar-demo.js"></script>
<script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
<script src="{{ asset('admin-asset') }}/js/datatables-simple-demo.js"></script>
</body>
</html>
