...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('front-end-asset')}}/css/font-awesome.min.css">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{asset('front-end-asset')}}/css/owl.carousel.css">
...
<!-- jQuery easing -->
<script src="{{asset('front-end-asset')}}/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="{{asset('front-end-asset')}}/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="{{asset('front-end-asset')}}/js/bxslider.min.js"></script>
<script type="text/javascript" src="{{asset('front-end-asset')}}/js/script.slider.js"></script>
</body>
</html>
